    ...
    $.dlxQuiz = function ( element, options ) {
      var plugin = this,
        ...
        defaults = {
          ...
          nextButton_text: "التالى",
          completeButton_text: "إنهاء الاختبار",
          viewResultsButton_text: "عرض النتائج",
          resultsHeader_text: "إليك كيف فعلت.",
          quizScore_text: "لقد أجبت على  %totalScore من أصل %totalQuestions أسئلة بشكل صحيح",
          quizScoreMessage_text: "",
          quizScoreRank_text: {
            a: "علامة كاملة !",
            b: "عمل عظيم !",
            c: "على الأقل لقد مررت.",
            d: "كان يجب أن يدرس أكثر.",
            f: "هل حاولت حتى؟"
          },
        ...
        class_questionTitle = "questionTitle font-weight-bold h4",
